...
GraphQL is not a replacement for REST API’s, it complements a REST API by compensating for some of the drawbacks of using the REST specification. (I have also seen some teams replace the REST design completely with a GraphQL approach.) Some of the drawbacks of REST API’s are
...
### Underfetching
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/graphql-underfetching.png?raw=true" caption="Underfetching" %}
