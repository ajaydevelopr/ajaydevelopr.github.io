...
description: An API gateway is an API management tool that sits between a client and a collection of backend services.
---
...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/API-gateway-design.png?raw=true" caption="API Gateway Design" %}
...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/API-gateway-Functions.png?raw=true" caption="API Gateway functionality" %}
...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/API-Gateway-BFF.jpg?raw=true" caption="API Gateway - BFF" %}
