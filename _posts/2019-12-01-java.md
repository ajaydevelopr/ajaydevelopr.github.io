...
tags: [JAVA, Clean Code, Cheatsheet]
style: fill
color: orange
description: Java is a popular programming language. It is used to develop mobile apps, web apps, desktop apps, games and much more.
---
