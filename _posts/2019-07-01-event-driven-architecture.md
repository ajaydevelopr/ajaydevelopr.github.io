...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/Exactly-Once.png?raw=true" caption="Exactly Once" %}
...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/Event-Driven-Architecture-1024x378.png?raw=true" caption="Event Driven Architecture" %}
...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/Mediator-Topology.png?raw=true" caption="Mediator Topology" %}
...
{% include elements/figure.html image="https://github.com/ajaydevelopr/Blog-Pictures/blob/main/blog_pics/Broker-Topology.png?raw=true" caption="Broker Topology" %}
